...
RCT_EXPORT_METHOD(isAdidAppendedToInAppUrls:(RCTPromiseResolveBlock)resolve rejecter:(__unused RCTPromiseRejectBlock)reject) {
    dispatch_async(self.returnQueue, ^{
        resolve(@([Localytics isInAppAdIdParameterEnabled]));
    });
}
...
#pragma mark Inbox
RCT_EXPORT_METHOD(getInboxCampaigns:(RCTPromiseResolveBlock)resolve rejecter:(__unused RCTPromiseRejectBlock)reject) {
    dispatch_async(self.returnQueue, ^{
        resolve([LocalyticsPlugin getInboxCampaigns]);
    });
}
...
RCT_EXPORT_METHOD(isAdidAppendedToInboxUrls:(RCTPromiseResolveBlock)resolve rejecter:(__unused RCTPromiseRejectBlock)reject) {
    dispatch_async(self.returnQueue, ^{
        resolve(@([Localytics isInboxAdIdParameterEnabled]));
    });
}
